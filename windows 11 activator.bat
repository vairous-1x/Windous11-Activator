@echo off
title Windows 11 Activator BY Vairous1x
cls
echo ++++++++++++++++++++++++++++++++++++++++
echo             Vairous1x 
echo ++++++++++++++++++++++++++++++++++++++++
echo      Start Windows 11 activation ...
...
if %i%==5 set KMS_Sev=kms.shuax.com
if %i%==6 (
    echo All servers tried, activation failed.
    pause
    exit
)
...
cscript //nologo c:\windows\system32\slmgr.vbs /ato | find /i "successfully" && (
    ...
    echo Failed to activate. Trying another server...
    set /a i+=1
    goto server
)
